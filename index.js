...
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
    if (config.SESSION_ID && config.SESSION_ID.trim() !== "") {
        const sessdata = config.SESSION_ID.replace("FLAX-MD~", '');
        try {
...
const port = process.env.PORT || 9090;
  ...
  let up = `*Hello there MEGATRONE MD User! \ud83d\udc4b\ud83c\udffb* \n\n> Simple , Straight Forward But Loaded With Features \ud83c\udf8a, Meet MEGATRON-MD WhatsApp Bot.\n\n *Thanks for using BOYKA-XD \ud83d\udea9* \n\n> Join WhatsApp Channel :- ⤵️\n \nhttps://whatsapp.com/channel/0029Vb6Z0adGpLHW1xIsF61D \n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/FlaxMalcom/CRISES-MD V1\n\n> © 𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 FLAX MALCOM  ❣️ \ud83d\udda4`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/mi2k2o.jp` }, caption: up })
  }
  })
  ...
  const pushname = mek.pushName || 'Flax Malcom'
...
const flaxmalcom = ['263775597819','263716985350'] 
const dev = [] 
