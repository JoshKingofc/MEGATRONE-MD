...
cmd({
  ...
  try {
    ...
    let _0x2dbca0 = await fetch('https://okatsu-rolezapiiz.vercel.app/downloader/ytmp3?url=${encodeURIComponent(youtubeUrl)}' + encodeURIComponent(_0x2d6fc6));
...
cmd({
  ...
  try {
    ...
    let _0x32732f = await fetch("https://api-rin-tohsaka.vercel.app/download/ytmp4?url=" + encodeURIComponent(_0x3460a4));
    ...
    await _0x291138.sendMessage(_0x3764b7, {
      ...
      'caption': "𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 MEGATRONE-MD"
    }, {
      'quoted': _0x40711d
    });
  } catch (_0x4a5abf) {
